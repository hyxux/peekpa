...
urlpatterns = [
    ...
    path("dashboard/category/manage", views.category_manage_view,
         name="category_manage_view"),
    path("dashboard/category/publish", views.category_publish_view,
         name="category_publish_view"),
    path("dashboard/category/add", CategoryView.as_view(), name="category_add"),

    path("dashboard/category/edit", CategoryEditView.as_view(),
    ...
    path("dashboard/post/publish", views.post_publish_view,
         name="post_publish_view"),
...
#     友链查看
    ...
    path("dashboard/link/publish", views.link_publish_view,
         name="link_publish_view"),
...
# 查看广告
    path("dashboard/advertise/manage", views.advertise_manage_view,
         name="advertise_manage_view"),
# 广告新增功能
    path("dashboard/advertise/publish", views.advertise_publish_view,
         name="advertise_publish_view"),

# 新建广告
    path("dashboard/advertise/add", AdvertiseView.as_view(), name="advertise_add"),
    

    path("dashboard/advertise/edit", AdvertiseEditView.as_view(),
         name="advertise_edit_view"),

    

    path("dashboard/advertise/delete",
         AdvertiseDeleteView.as_view(), name="advertise_delete"),

    path("dashboard/user/manage", views.user_manage_view, name="user_manage_view"),



    path("dashboard/user/publish", views.user_publish_view,
         name="user_publish_view"),
