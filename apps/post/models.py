...
class Post(models.Model):
    ...
    author = models.ForeignKey(
        'bloguser.User', on_delete=models.SET_NULL, null=True)
    ...
    status = models.PositiveIntegerField(
        default=STATUS_DRAFT, choices=STATUS_ITEMS)
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.time_id or len(self.time_id) == 0:
            ...
            self.time_id = self.publish_time.strftime(
                "%Y%m%d") + str(random.randrange(999, 10000, 1))
